...
const EXPECTED_E2E_FULL_OUTPUT = [
  "/**",
  ...
  "// Connections",
  "",
  'export const main = createKafkaConnection("main", {',
...
const EXPECTED_E2E_DATASOURCE_ONLY_OUTPUT = [
  "/**",
  " * Generated by tinybird migrate.",
  " * Review endpoint output schemas and any defaults before production use.",
  " */",
...
`
    ...
    expect(output).toBe(EXPECTED_E2E_FULL_OUTPUT);
  });
...
`
    ...
    expect(generated).toBe(EXPECTED_E2E_DATASOURCE_ONLY_OUTPUT);
